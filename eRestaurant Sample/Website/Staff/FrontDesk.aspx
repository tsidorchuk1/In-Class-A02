       ...
       <div class="row col-md-12">
        ...
        <h4>Mock Date/Time</h4>
               <div class="pull-right col-md-5">
                   ...
                   <asp:Repeater ID="AdHocBillRepeater" runat="server"
                       ItemType="System.DateTime" DataSourceID="AdHocBillDataSource">
                       <ItemTemplate>
                   ...
                   <asp:ObjectDataSource runat="server" ID="AdHocBillDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="GetLastBillDateTime" TypeName="eRestaurant.BLL.AdHocController"></asp:ObjectDataSource>
               </div>
           ...
           <div class="pull-right col-md-5">
               <details open>
                   ...
                   <asp:Repeater ID="ReservationsRepeater" runat="server"
                       ...
                       <ItemTemplate>
                           <h4><%# Item.Time %></h4>
                           <%# Item.Reservations.Count %> reservations at this time-slot
                     ...
                     <Columns>
                        ...
                        <%-- <asp:BoundField DataField="Table" HeaderText="Table" SortExpression="Table"></asp:BoundField>--%>
                         ...
                         <asp:TemplateField>
                            ...
                            <%-- defining a custom built column --%>
                             <asp:Panel ID="WalkinSeatingPanel" runat="server" CssClass="input-group input-group-sm" Visible="<%# ! Item.Taken %>">
                                 ...
                                 <asp:TextBox ID="NumberInParty" runat="server" CssClass="form-control col-md-1" TextMode="Number"
                             ...
                             <asp:LinkButton ID="LinkButton1" runat="server" Text="Seat Customers" CssClass="input-group-btn" CommandName="Select"
                                 ...
                                 <asp:Panel ID="ReservationInfoPanel" runat="server" Visible="<%# Item.Taken %>">
                        ...
                        <%-- <asp:BoundField DataField="BillTotal" HeaderText="BillTotal" SortExpression="BillTotal"></asp:BoundField>--%>
                         ...
                         <%--<asp:BoundField DataField="Reservation" HeaderText="Reservation" SortExpression="Reservation"></asp:BoundField>--%>
                     </Columns>
                 </asp:GridView>
